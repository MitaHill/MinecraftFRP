...
from PySide6.QtCore import QTimer, QMutex, QMutexLocker, QEventLoop, Qt
from PySide6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QPushButton, 
                              QLabel, QComboBox, QLineEdit, QTextEdit, QMessageBox, 
                              QProgressDialog, QTabWidget, QApplication, QCheckBox)
...
from src.gui.server_management_dialog import ServerManagementDialog
...
class PortMappingApp(QWidget):
    ...
    def setupUI(self):
        ...
        self.auto_mapping_checkbox.setChecked(self.auto_mapping_enabled)
        self.auto_mapping_checkbox.stateChanged.connect(self.on_auto_mapping_changed)
        settings_layout.addWidget(self.auto_mapping_checkbox)
        ...
        settings_layout.addWidget(auto_mapping_desc)

        # 熄灭灯泡（夜间模式）设置
        self.dark_mode_checkbox = QCheckBox("熄灭灯泡（夜间模式）")
        self.dark_mode_checkbox.setChecked(self.dark_mode_override and self.force_dark_mode)
        ...
        settings_layout.addWidget(dark_mode_desc)
        ...
        settings_layout.addWidget(server_mgmt_button)
        ...
        settings_layout.addWidget(server_mgmt_desc)
