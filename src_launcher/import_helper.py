...
def smart_import(module_path, package_name):
    ...
    Args:
        module_path: 相对路径，如 "core.update_checker"
        package_name: 包名，如 "src_launcher"
    ...
    Example:
        # 在 src_launcher 中使用:
        UpdateChecker = smart_import("core.update_checker", "src_launcher").UpdateChecker
    """
    try:
        # 打包后的路径 (相对导入)
...
def get_from_module(module_path, package_name, attr_name):
    ...
    Example:
        UpdateChecker = get_from_module("core.update_checker", "src_launcher", "UpdateChecker")
    """
